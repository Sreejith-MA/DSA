...
<br>
	...
	<div class=col-md-4> <img class="rounded" src="img/ten.jpg" style="width: 100px;
	height: 80px padding: 5px;" > 
	</div>
	<div class=col-md-8> <br> <span class="side_post"><a href="index.php"> Customer Service </a> </span> </div>
	</div>
	<br>
